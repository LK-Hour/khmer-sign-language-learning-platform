...
const translations: Record<Locale, Translations> = {
  kh: {
    ...
    fsSampleCaption: 'រូបភាពគំរូជាមួយ keypoints',
    fsCameraCaption: 'កាមេរ៉ាអ្នករៀនផ្ទាល់ជាមួយ keypoint overlay',
  ...
  en: {
    ...
    fsSampleCaption: 'Sample image with hand keypoints',
    fsCameraCaption: 'Live learner camera with keypoint overlay',
    fsPressRecToPractice: 'Press REC to start practice',
