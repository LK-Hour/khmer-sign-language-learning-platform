...
export default function ChapterAccordion({
  ...
  const { primary, secondary } = getChapterRangeDescriptionPair(chapter, locale);
      ...
      <Collapse in={expanded && !locked} unmountOnExit>
        ...
        >
          ...
          <LessonProgressRow
            ...
            actionLabel={practiceLocked ? `After ${chapter.lessonCount} lessons` : "Start"}
          />
        </Box>
      </Collapse>
    </Box>
